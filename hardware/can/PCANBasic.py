...
PCAN_LAN_CHANNEL_DIRECTION = TPCANParameter(
    0x2F)  # Communication direction of a PCAN-Channel representing a PCAN-LAN interface
...
TRACE_FILE_DATA_LENGTH = int(
    0x100)  # Causes using the data length column ('l') instead of the DLC column ('L') in the trace file
