...
from hardware.io_card.vendor.yanhua.Automation.BDaq.BDaqApi import TArray
from hardware.io_card.vendor.yanhua.Automation.BDaq.BDaqApi import TDioFeatures
