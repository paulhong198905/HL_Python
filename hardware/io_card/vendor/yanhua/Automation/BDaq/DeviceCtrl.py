...
from hardware.io_card.vendor.yanhua.Automation.BDaq.BDaqApi import TArray, TerminalBoard
from hardware.io_card.vendor.yanhua.Automation.BDaq.BDaqApi import TDeviceCtrl, BioFailed
