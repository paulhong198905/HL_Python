...
from hardware.io_card.vendor.yanhua.Automation.BDaq.BDaqApi import TDiintChannel, BioFailed
from hardware.io_card.vendor.yanhua.Automation.BDaq import ErrorCode, ActiveSignal
